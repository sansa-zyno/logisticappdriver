      ...
      builder: (controller) {
        return WillPopScope(
          ...
          child: SafeArea(
            child: Scaffold(
              appBar: AppBar(
                backgroundColor: controller.selectedDrawerIndex.value == 5
                        ...
                        currentAccountPicture: ClipOval(
                          child: Container(
                            ...
                            errorWidget: (context, url, error) =>
                                ...
                                Image.asset(
                              controller.userModel!.userData!.photoPath
                                  .toString(),
                              height: 40,
                            ),
                          ),
                              ...
                              child: Switch(
                                  ...
                                  onChanged: (value) {
                                    ...
                                    Map<String, dynamic> bodyParams = {
                                      'id_driver': Preferences.getInt(
                                          Preferences.userId),
                                      'online': controller.isActive.value
                                          ? 'yes'
                                          : 'no',
                                    };
