...
import 'package:logistic_app_driver/controller/dash_board_controller.dart';
import 'package:logistic_app_driver/controller/ride_details_controller.dart';
import 'package:logistic_app_driver/model/ride_model.dart';
//import 'package:logistic_app_driver/page/chats_screen/conversation_screen.dart';
import 'package:logistic_app_driver/themes/button_them.dart';
import 'package:logistic_app_driver/themes/constant_colors.dart';
import 'package:logistic_app_driver/themes/custom_alert_dialog.dart';
import 'package:logistic_app_driver/themes/custom_dialog_box.dart';
import 'package:logistic_app_driver/utils/Preferences.dart';
import 'package:logistic_app_driver/widget/StarRating.dart';
...
class _RouteViewScreenState extends State<RouteViewScreen> {
  ...
  @override
  void initState() {
    setIcons().then((value) => getArgumentData());
            ...
            rideData == null
                ...
                : GoogleMap(
                    ...
                    initialCameraPosition: CameraPosition(
                      target: rideData != null
                          ? LatLng(double.parse(rideData!.latitudeDepart!),
                      ...
                      Padding(
                        ...
                        child: Row(
                          children: [
                            ...
                            Visibility(
                              visible: rideData!.statut == "confirmed"
                                  ? true
                                  : false,
                              child: Expanded(
                                child: Padding(
